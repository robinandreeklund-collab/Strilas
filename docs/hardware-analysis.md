...
| **Sikteskamera + edge-AI** (fuserad pose-väg, uppgradering, se ⓥ) | **P4 MIPI-CSI: OV5647** (rolling, v1) / **ams-OSRAM Mira220** (global shutter, NIR — P4-stödd) + ArUco-läsning, **centrerad i emitter-ringen** | $25–200 | bäring + zon + ID optiskt (HITS/TrackingPoint-vägen). **OBS: IMX296 = Pi-only, ingen P4-drivrutin** |

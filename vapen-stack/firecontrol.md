...
| U1 | TDK ICM-42688-P (LGA-14) | **extra IMU #1**, I²C 0x69 (AD0 hög), INT=GPIO50 |
| U2 | TDK ICM-42688-P (LGA-14) | **extra IMU #2**, I²C 0x68 (AD0 låg), INT=GPIO49 |
...
> **2 IMU på delad I²C-buss** (max på en buss — ICM-42688-P har bara adress 0x68/0x69).

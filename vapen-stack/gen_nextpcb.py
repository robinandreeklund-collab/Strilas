...
MPN = {
    ...
    "VSMY98545_850nm": ("VSMY98545", "Vishay", "IR-LED 850nm högeffekt ±45° domed SMD, Ie 380mW/sr@1A / 1600@5Apuls (konstellation; in-stock-verifierad ersättare för OSLON, ledtid 7-18d)", "", "NextPCB sourcar + SMT-placerar. 850nm matchar kamerans bandpass (rejekterar 940nm-taggen). OBS lägre Ie/A än OSLON → driv hårdare (pulsad) f. 150m, kräver ögonsäkerhets-ommätning"),
    "L1I0-0850090200000": ("L1I0-0850090200000", "Lumileds", "IR-LED 850nm LUXEON IR Domed 90° SMD 3.7×3.7mm, ~750 mW/sr@1A (≈2× VSMY), 1.5A DC / 5A puls, Vf~3.2V@1A (konstellation)", "", "NextPCB sourcar + SMT-placerar (precision). 850nm matchar kamerans bandpass (rejekterar 940nm-taggen). Pinout pad1=K verif. SamacSys; vår footprint pad2=K (konsekvent m schema, D1 rot180 på led-tab). Starkare → når räckvidd vid LÄGRE ström → eye-safety-marginal ökar (men kräver ommätning, se eye-safety-budget.md)"),

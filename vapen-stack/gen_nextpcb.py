...
MPN = {
    ...
    "100uF": ("C3225X5R1E107M250AC", "TDK", "MLCC 100uF 25V X5R 1210", "", "NOTE: >=16V f. 2S (8.4V)"),
    ...
    "SFH4725S_940nm":("SFH 4725S", "ams OSRAM", "IR-emitter 940nm OSLON Black", "", ""),
    "PTC_1A":      ("MF-MSMF075/16-2", "Bourns", "PTC resättbar 0.75A-hold 16V 1206", "", "NOTE: verifiera hold-ström/spänning (VBAT 2S)"),
    "ICM-45686":   ("ICM-45686", "TDK InvenSense", "6-axlig IMU (SPI/I2C) LGA-14", "", ""),

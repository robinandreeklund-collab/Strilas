...
| `vest-patch/` | Väst-/hjälm-patch (×14; 6-pol JST + 2-pol motor-JST J2; ERM coin-motor pluggas in + 3M-fästs i keepout-ring på baksidan — DNP/kundmonterad) | rund Ø45 mm | 2 | 4 |
